...
/**
 * Created by gongchen on 2016/5/24.
 */
public class MultiCategoryMoreRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MultiCategoryMoreRecyclerViewAdapter(Context context, List data, List<Integer> imgs) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            View view = mLayoutInflater.inflate(R.layout.multi_category_popular_item_small, viewGroup,
                    false);
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View view) {
            super(view);
            mTextView = (TextView) view.findViewById(R.id.text_card_popular_item_small);
            mImageView = (ImageView) view.findViewById(R.id.image_card_popular_item_small);
        }
    }
