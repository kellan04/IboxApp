 ...
 */
public class IboxRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public IboxRecyclerViewAdapter(Context context, List data, List<Integer> imgs) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            View view = mLayoutInflater.inflate(R.layout.ibox_cardview, viewGroup,
                    false);
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View view) {
            ...
            mTextView = (TextView) view.findViewById(R.id.text_card_box);
            mImageView = (ImageView) view.findViewById(R.id.image_card_box);
        }
    }
